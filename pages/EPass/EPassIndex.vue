      ...
      >
        ...
        <view class="cu-form-group">
          ...
          <checkbox-group @change="checkboxZukeChange">
            <view class="cu-form-group">
              <checkbox
                :class="isCheckZuke?'checked':''"
                :checked="isCheckZuke?true:false"
                value="1"
              ></checkbox>
            </view>
          </checkbox-group>
        ...
        <view class="cu-form-group">
          ...
          <checkbox-group @change="checkboxHomeChange">
            <view class="cu-form-group">
              <checkbox
                :class="isHomeAddress?'checked':''"
                :checked="isHomeAddress?true:false"
                value="1"
              ></checkbox>
            </view>
          </checkbox-group>
        ...
        <!-- 居住详址 -->
        <view
          class="cu-form-group align-start"
          v-if="isHomeAddress"
        >
          <view class="title require-ico">居住详址</view>
          <textarea
            name="selfCompiledAddress"
            maxlength="100"
            placeholder="请输入您的房屋地址"
          ></textarea>
        </view>
        <!-- 工作地址 -->
        <view class="cu-form-group">
        ...
        <view class="cu-form-group margin-top">
          ...
          <checkbox-group @change="checkboxSuiChange">
            <view class="cu-form-group">
              <checkbox
                :class="isCheckSui?'checked':''"
                :checked="isCheckSui?true:false"
                value="1"
              ></checkbox>
            </view>
          </checkbox-group>
...
export default {
  ...
  methods: {
    ...
    async getPersonByZjhm() {
      ...
      const { data, appCode } = await this.$request.post(
